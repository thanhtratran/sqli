...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="./mvc/assets/img/undraw_rocket.svg" alt="...">
    ...
    <!-- Page level plugins -->
    <script src="./mvc/assets/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="./mvc/assets/js/demo/chart-area-demo.js"></script>
    <script src="./mvc/assets/js/demo/chart-pie-demo.js"></script>
